...
Créez un nouveau repo à partager avec [filiunino@gmail.com](mailto:filiunino@gmail.com) avant 13:00.

Les réponses à l’exercice 1 se feront dans `./teamwork.md`.

Le refactoring de l’exercice 2 se fera dans `flappy-bird.cpp`

# Exercice 1 - teamwork

Skull & Bones est aujourd’hui considéré comme un des plus gros échecs de l’industrie du jeu. Développé par Ubisoft Singapour à part de 2013 avec une release date initialement prévue pour 2018, le développement a coûté $200 millions et a finalement été publié en 2024 pour faire immédiatement face à un échec commercial, les joueurs le décrivant comme un clone de Black Flag sorti dix ans auparavant.

Dans ce post mortem d’un game dev ayant travaillé sur le projet, repérez les anti-patterns démontrés par l’équipe et suggérez des changements de management qui auraient pu changer pour le mieux la trajectoire du projet (~1page).

[The Tragedy of Skull and Bones](https://jboger.substack.com/p/the-tragedy-of-skull-and-bones)

# Exercice 2 - clean code

Ci-dessous, un code de mauvaise qualité.

1. Expliquez ce que le programme fait
2. Prenez note de tous les code smells, anti-patterns, “dirty code” et autre défauts d’implémentation
3. Refactorez le code, étape par étape. Faites un commit par étape, avec en description de commit le changement effectué.
- game.cpp
